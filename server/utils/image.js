...
const COMPARISON_PROMPT = `Outfit Analysis: Please use the portrait photo I've uploaded to create a high-quality personal outfit analysis card. Style categories to include: Korean, Streetwear, Tea-toned, Chic, Chanel-inspired, Indian Style, Baddie, Niche/Indie, Vintage, Gen-Z Style Clothing, and Sporty. Preserve the subject's original facial features, skin tone, face shape, and real characteristics. Using a side-by-side comparison layout, show the effect of different outfits on the subject, clearly distinguishing between styles, making it immediately obvious which looks enhance the complexion and elevate overall quality. The layout should be clean and fashionable, resembling a professional image consultant report, visually driven throughout, using only short style-name labels, with no lengthy body text and no rating words like "Recommended", "Average", or "Avoid". High resolution, information clearly presented, suitable for sharing on social media.`;
